...
if __name__ == "__main__":
    ...
    class A:
        ...
        def poolRun(self):
            ...
            pool.queueTask(self.sortTask, (1000, 100000), self.taskCallback)
            pool.queueTask(self.waitTask, 5, self.taskCallback)
            pool.queueTask(self.sortTask, (200, 200000), self.taskCallback)
            pool.queueTask(self.waitTask, 2, self.taskCallback)
            pool.queueTask(self.sortTask, (3, 30000), self.taskCallback)
            pool.queueTask(self.waitTask, 7, self.taskCallback)
