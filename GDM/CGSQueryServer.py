...
#       # A variable for the preprocessed visualization settings
    ...
    def __waitForDatasetServer__(self):
        print "__waitForDatasetServer__"
...
#                           "-P .completesearch_"+socket.gethostname()+"_"+str(port)+".pid"
    ...
    def getCoverages(self, genome, datasetName):
        ...
        try:
            ...
            log_CDS("getCoverages: Error: traceback:"+repr(traceback.format_tb(exc_traceback)))
            errorMessage = str(ex)
            log_CDS("getCoverages: Error: in short "+errorMessage)
            answer = {}
        return answer
